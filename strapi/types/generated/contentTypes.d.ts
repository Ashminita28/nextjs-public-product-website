...
export interface ApiFeatureFeature extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['operations', 'analytics', 'reporting', 'infrastructure']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiLandingPageLandingPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    capabilities: Schema.Attribute.Component<'landing.capability', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    module: Schema.Attribute.Component<'landing.module', true>;
    pricing_plans: Schema.Attribute.Relation<
      'oneToMany',
      'api::pricing-plan.pricing-plan'
    >;
    problem: Schema.Attribute.Component<'shared.problem', false>;
    publishedAt: Schema.Attribute.DateTime;
    solution: Schema.Attribute.Component<'shared.solution', true>;
...
export interface ApiPricingPlanPricingPlan extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    text: Schema.Attribute.Component<'pricing.feature-item', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
